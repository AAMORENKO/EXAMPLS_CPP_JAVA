...
void main()
{
    ...
    _chdir(pvd);
		...
		cout<<endl<<endl;
		cout<<" ---------------------------------------------- "<<endl;
		cout<<"|               Äèñê R: ïîäêëþ÷åí              |"<<endl;
		cout<<"|          Îòêëþ÷àåì âèðòóàëüíûé äèñê R:       |"<<endl;
		cout<<" ---------------------------------------------- "<<endl;
		Sleep(tms);
		system(d_vdx);
		cout<<" ============================================== "<<endl;
		cout<<"|               Äèñê R: îòêëþ÷åí               |"<<endl;
		cout<<" ============================================== "<<endl;
		_chdir(host_dir);
		system(kill_host);
		Sleep(tms);
        ...
        cout<<"\nÎòêëþ÷àåì ïî÷òîâóþ ñëóæáó"<<endl;
        WinExec(mail_stop,SW_RESTORE);
    	Sleep(tms);

		cout<<"\nÎòêëþ÷àåì Apache Service"<<endl;
		...
		cout<<endl<<endl;
		cout<<" ---------------------------------------------- "<<endl;
		cout<<"| Çàäàíèå âûïîëíåíî. Ñèñòåìà ãîòîâà ê ðàáîòå.  |"<<endl;
		cout<<" ---------------------------------------------- "<<endl;
