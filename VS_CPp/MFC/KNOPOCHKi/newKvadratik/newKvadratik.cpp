...
// newKvadratik.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CnewKvadratikApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CnewKvadratikApp

CnewKvadratikApp::CnewKvadratikApp()
{
...
// Единственный объект CnewKvadratikApp

CnewKvadratikApp theApp;


// инициализация CnewKvadratikApp

BOOL CnewKvadratikApp::InitInstance()
{
