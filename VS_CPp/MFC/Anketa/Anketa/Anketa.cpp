...
// Anketa.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CAnketaApp, CWinApp)
...
// Единственный объект CAnketaApp

CAnketaApp theApp;


// инициализация CAnketaApp

BOOL CAnketaApp::InitInstance()
{
